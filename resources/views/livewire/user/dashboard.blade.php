...
new class extends Component {
    ...
    return $this->temperature() > 29 || $this->gas() > 1500 || $this->smoke() > 0;
    }
    ...
    #[Computed]
    function gasColor() {
        return $this->gas() > 1500 ? 'text-red-600' : 'text-green-600';
    }

    #[Computed]
    function gasBackground() {
        return $this->gas() > 1500 ? 'bg-red-200' : 'bg-green-200';
    }
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="p-4 rounded-lg {{ $this->gasBackground() }}">
            <x-stat
                ...
                :value="$this->gas() > 1500 ? __('messages.gas_detected') : __('messages.no_gas')"
                icon="o-rss"
                :color="$this->gasColor()" />
        </div>
